...
namespace ObfuscarTools
{
    ...
    public sealed class ObfuscarToolsPackage : AsyncPackage
    {
	    /// <summary>
	    ///     ObfuscarToolsPackage GUID string.
	    /// </summary>
	    public const string PackageGuidString = "1868a37c-9af0-484d-b780-54d8534444c9";
        ...
        protected async override Task InitializeAsync(CancellationToken cancellationToken, IProgress<ServiceProgressData> progress)
        {
            ...
            await AddObfuscarCommand.InitializeAsync(this);
            await RemoveObfuscarCommand.InitializeAsync(this);
            await ObfuscarSettingsCommand.InitializeAsync(this);
        }
